module attributes {transform.with_named_sequence} {
  ...
  // transform.mark_parallel %new_for_m num_threads = 8 : (!transform.any_op) -> !transform.any_op
  ...
  // transform.mark_unroll %for_n unroll_factor = 2 : (!transform.any_op) -> !transform.any_op
...
//   %D_ddr = transform.get_operand %add_relu_m_n_m[1] : (!transform.any_op) -> !transform.any_value
...
//   %C2_result_am = transform.get_result %add_relu_m_n_m[0] : (!transform.any_op) -> !transform.any_value
